...
<body>
        ...
        <div class="collapse navbar-collapse pl-4" id="navbarSupportedContent">
            <ul class="navbar-nav mr-auto">
                <li class="nav-item active">
                    <a class="nav-link" href="monitor.php">Monitor <span class="sr-only">(current)</span></a>
                </li>
                <li class="nav-item">
    ...
    <script>
        function displyProjectsList(data) {
            ...
            for (var i = 0; i < data.length; i++) {
                ...
                <tr class="project-`+ status_text +`">
                    ...
                    <td>
                        <button type="button" class="btn btn-`+ btn_restart_class +` px-3 rounded-pill" onclick="restart('`+ status_text +`');"><i class="fas fa-bolt mr-1"></i> Restart</button>
                    </td>
                </tr>
                `;
            }
        ...
        function projectsList() {
            ...
            $.get('/check_status/service/project-list.php', function(data) {
