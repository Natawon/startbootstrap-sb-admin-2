        ...
        <div class="collapse navbar-collapse pl-4" id="navbarSupportedContent">
            <ul class="navbar-nav mr-auto">
                <li class="nav-item active">
                    <a class="nav-link" href="/manage/index2.php">back <span class="sr-only">(current)</span></a>
                </li>
            </ul>
        </div>
    </nav>
...
<input class="form-control input-sm" type="hidden" name="url" value="Froggenius" />
</div>
<div class="form-group">
...
<a href="./login2.php"  class="btn btn-default btn-lg" name="sub">
Cancel</a>
</div>
</div><!----container--->
</div><!----row--->
