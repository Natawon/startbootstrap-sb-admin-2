                                    ...
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            ...
                                            <?php 
                                                ...
                                                ?>
                                            <div class="h5 mb-0 font-weight-bold text-gray-800">$ <?php echo $row['costs'];?></div>
                                                <?php }                                                    
                                                ?>
                                                <?php 
                                                $sum =0 ;
                                            ...
                                            ?>
                                             <?php
                                                       if(round($percentage,2) >= 0)
                                                       {
                                                       echo" <div style='color:green' class='caption fw-500 me-2'><i class='fa fa-arrow-up'></i>  style='color:green;'> ". round($percentage,2)." %  from last month<span></div>";
                                                       }else{
                                                        echo" <div style='color:red' class='caption fw-500 me-2'><i class='fa fa-arrow-down'></i> <span style='color:red;'> ". round($percentage,2)." %  from last month<span></div>";
                                                       }
                                                    ?>
