            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        ...
                        <a href="/manage/check_status/input.php" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <a class="btn btn-primary" href="logout2.php">Logout</a>
                </div>
            </div>
        </div>
    </div>
